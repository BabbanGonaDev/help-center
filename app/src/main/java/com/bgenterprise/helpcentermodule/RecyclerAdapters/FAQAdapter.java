...
public class FAQAdapter extends RecyclerView.Adapter<FAQAdapter.FAQViewHolder> {
    ...
    private List<IssuesEnglish> faqList;

    /**
     * TODO: Use the Recyclers from LMTC app as a guide
     */

    public FAQAdapter(Context context, List<IssuesEnglish> faqList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull FAQViewHolder holder, int position) {
        IssuesEnglish issue = faqList.get(position);
